# -*- coding: utf-8 -*-
"""
Created on Tue Mar 29 13:44:22 2022
...
directory = 'C:\\Users\\Kristin\\Documents\PhD\FAC\Residuen_leveled_imf_sorted_10deg\\'
...
for i in range(len(theta)-1):
    ...
    for j in range(len(phi)-1):  
        ...
        indices_imf_condition = np.where(np.isin(orbit_number, orbit_numbers_sunward))
