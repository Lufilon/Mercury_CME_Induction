...
directory = 'C:\\Users\\Kristin\\Documents\PhD\FAC\Residuen_plots_plasma_beta_tao\\Bz_sorted\\plasma_beta_0-5\\'+ plasma_beta + '_plasma_beta\\Bz_' + bz_direction + '\\'
...
cbar = plt.colorbar()
cbar.set_label('   nA/m$^2$', labelpad=-40, y=1.05, rotation=0)
plt.title('j (radial), scaled with R$_M$, with pedersen correction, ' + plasma_beta + ' plasma beta, IMF-Bz ' + bz_direction)
...
cbar = plt.colorbar()
cbar.set_label('   nA/m$^2$', labelpad=-40, y=1.05, rotation=0)
plt.title('j (radial), scaled with R$_M$, zoomed, with pedersen correction, ' + plasma_beta + ' plasma beta, IMF-Bz ' + bz_direction)
