...
number_of_measurements = np.zeros([len(phi)-1, len(theta)-1])
...
for i in range(len(theta)-1):
    ...
    for j in range(len(phi)-1):  
        ...
        indices_plasma_beta = indices_plasma_beta_low
        ...
        orbit_b_x = orbit_b_x[indices_plasma_beta]
        orbit_b_y = orbit_b_y[indices_plasma_beta]
        orbit_b_z = orbit_b_z[indices_plasma_beta]
