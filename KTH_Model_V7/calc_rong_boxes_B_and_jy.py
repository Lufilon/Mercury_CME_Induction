# -*- coding: utf-8 -*-
"""
Created on Fri May 20 14:35:38 2022
...
for i in range(length_x): 
    for j in range(length_z):
        ...
        #print('Orbit without DI: ', orbit_number[i] )
            ...
            KTH_B = kth14_model_for_mercury_v7(orbit_pos_x, orbit_pos_y, orbit_pos_z, r_hel, DI, True, True, True, True, True)
...
#np.savetxt('C:\\Users\\Kristin\\Documents\\PhD\\Neutralschichtstromanpassung_neu\\jy_Day_Nightside\\j_y_208nT.txt', j_y_2_average)
...
cbar.set_label('   nA/m$^2$', labelpad=-40, y=1.05, rotation=0)
plt.clim(-lim_b,lim_b)
plt.title('j_y (calculated with $\Delta$B (MES - KTH))')
ax.axis('equal')
column_labels = x_condition_list 
row_labels = z_condition_list
ax.set_xticklabels(column_labels)
