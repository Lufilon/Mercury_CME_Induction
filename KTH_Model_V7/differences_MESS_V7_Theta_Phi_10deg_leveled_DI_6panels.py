# -*- coding: utf-8 -*-
"""
Created on Fri Jul 15 12:56:44 2022
...
for i in range(len(theta)-1):
    ...
    for j in range(len(phi)-1):  
        ...
        index_DI_high = np.where(DI > 50.0)
        index_DI_low = np.where(DI < 50.0)
        
        index_DI = index_DI_high
    
        orbit_pos_x = orbit_pos_x[index_DI]
        orbit_pos_y = orbit_pos_y[index_DI]
        orbit_pos_z = orbit_pos_z[index_DI]
        orbit_b_x = orbit_b_x[index_DI]
        orbit_b_y = orbit_b_y[index_DI]
        orbit_b_z = orbit_b_z[index_DI]
        r_hel = r_hel[index_DI]
        DI = DI[index_DI]
        orbit_number = orbit_number[index_DI]
        orbit_doy = orbit_doy[index_DI]
...
np.savetxt(directory + 'diff_z_matrix_leveled_'+ ending, diff_z_matrix)
