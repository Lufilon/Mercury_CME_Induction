...
directory = 'C:\\Users\\Kristin\\Documents\PhD\FAC\Residuen\\'
diff_x_matrix = np.loadtxt(directory + 'diff_x_matrix_leveld.txt')
diff_y_matrix = np.loadtxt(directory + 'diff_y_matrix_leveld.txt')
diff_z_matrix = np.loadtxt(directory + 'diff_z_matrix_leveld.txt')

diff_r_matrix = np.loadtxt(directory + 'diff_r_matrix_leveld.txt')
diff_theta_matrix = np.loadtxt(directory + 'diff_theta_matrix_leveld.txt')
diff_phi_matrix = np.loadtxt(directory + 'diff_phi_matrix_leveld.txt')

theta = np.loadtxt(directory + 'theta_steps_leveld.txt')
phi = np.loadtxt(directory + 'phi_steps_leveld.txt')

r_mean = np.loadtxt(directory + 'r_mean_leveld.txt')
theta_mean = np.loadtxt(directory + 'theta_mean_leveld.txt')
phi_mean = np.loadtxt(directory + 'phi_mean_leveld.txt')
print(r_mean)
print(theta_mean)
print(phi_mean)
...
cbar = plt.colorbar()
cbar.set_label('   nA/m$^2$', labelpad=-40, y=1.05, rotation=0)
plt.title('j (radial), scaled with R$_M$, with corrected B$_x$')
plt.show()
...
cbar = plt.colorbar()
cbar.set_label('   nA/m$^2$', labelpad=-40, y=1.05, rotation=0)
plt.title('j (radial), scaled with R$_M$, zoomed')
