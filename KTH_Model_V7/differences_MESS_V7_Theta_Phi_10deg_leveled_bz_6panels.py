# -*- coding: utf-8 -*-
"""
Created on Fri Jul 15 11:26:04 2022
...
ending = 'bz_pos.txt'
np.savetxt(directory + 'diff_x_matrix_leveled_'+ ending, diff_x_matrix)
np.savetxt(directory + 'diff_y_matrix_leveled_'+ ending, diff_y_matrix)
np.savetxt(directory + 'diff_z_matrix_leveled__'+ ending, diff_z_matrix)

np.savetxt(directory + 'diff_r_matrix_leveled_'+ ending, diff_r_matrix)
np.savetxt(directory + 'diff_theta_matrix_leveled_'+ ending, diff_theta_matrix)
np.savetxt(directory + 'diff_phi_matrix_leveled_'+ ending, diff_phi_matrix)
np.savetxt(directory + 'r_mean_rm_'+ ending, r_mean_rm)
np.savetxt(directory + 'r_coord_list_'+ ending, r_coord_list)
