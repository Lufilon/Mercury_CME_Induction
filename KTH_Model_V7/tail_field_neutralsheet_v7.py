...
from current_profile_v7 import current_profile_v7


def tail_field_neutralsheet_v7(x_msm, y_msm, z_msm, di, control_params):
    ...
    current = current_profile_v7(rho_hankel, control_params)
